// Central article data. Add a new object here + a matching article-N.html page
// (copy article-1.html as a template) to publish a new piece.
const ARTICLES = [
  {
    id: 1,
    ...
    body: `<p>... huh, you actually clicked, welp let's get into it.</p>
      ...
      <p>that's pretty straightforward. Movin on-</p>`
  },
  {
    id: 2,
    ...
    body: `<p>"porsche... there is no substitute"</p>
      <img src="950660ae-5343-440a-8f35-1ff6ea3c925c-AMCJPHOTOS_964Turbo_Arizona_Finals-2026-21-tiny-2048x0.jpg" alt="964 turbo">
      ...
      <img src="Classic-&-Sports-Car-Porsche-911-GT3-06.jpg" alt="996 gt3">
